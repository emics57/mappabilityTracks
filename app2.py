...
viewer_footer = ui.input_select(
    "viewer_var", "Select variable", choices=["bill_length_mm", "body_mass_g"]
)
...
with ui.nav_panel("Genome Viewer"):
    with ui.navset_card_underline(title="Mappability Coverage Tracks", footer=viewer_footer):
